				...
				<article>
					...
					<div class="inner">
						...
						%>
							...
							<%
							String sql = "select * from dmm where mid='"+session.getAttribute("uid")+"' and status1='Approved'";
							...
							<td><a href="prostatus.jsp?pid=<%=pid%>&&d=<%=d%>" class="button small">Status</a></td></tr>
							<%} %>
							</table>
						</header>
					</div>
