				...
				<article>
					...
					<div class="inner">
						...
						<table>
							...
							<th style="color: white;">Issue</th><th style="color: white;">Status</th>
							<th style="color: white;">Date</th><th style="color: white;">SDate</th></tr>
							<%
							sql = "select * from issue where domain='"+dom+"' and cid='"+cid+"' and status1='Solved' and mro='"+uid+"'";
