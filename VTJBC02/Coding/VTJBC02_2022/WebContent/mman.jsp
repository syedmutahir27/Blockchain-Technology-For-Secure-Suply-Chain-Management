			...
			<section class="banner full">
				<article>
					...
					<div class="inner">
						...
						%>
							<h2 style="font-size: 5rem;">Manufacturing Details</h2>
							<table>
							<tr><th style="color: white;">DE ID</th><th style="color: white;">PID</th>
							<th style="color: white;">Date</th><th style="color: white;">Status</th></tr>
							<%
							String sql = "select userid from de where cid='"+session.getAttribute("uid")+"'";
							List<String> de = Dao.getMid(sql);
							Iterator<String> dir = de.iterator();
							while(dir.hasNext()){
								sql = "select * from dmm where userid='"+dir.next()+"'";
							...
							<td><a href="prostatus1.jsp?pid=<%=pid%>&&d=<%=d%>" class="button small">Status</a></td></tr>
							<%} 
							}%>
							</table>
						</header>
