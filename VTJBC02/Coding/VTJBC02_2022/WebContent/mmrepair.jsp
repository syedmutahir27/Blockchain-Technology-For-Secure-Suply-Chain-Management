				...
				<article>
					...
					<div class="inner">
						...
						<th style="color: white;">Solved Date</th></tr>
							...
							String sql = "select userid from mem where cid='"+session.getAttribute("uid")+"'";
							List<String> mid = Dao.getMid(sql);
							Iterator<String> mitr = mid.iterator();
							while(mitr.hasNext()){
								sql = "select * from issue where userid='"+mitr.next()+"'";						
							%>
								<%
