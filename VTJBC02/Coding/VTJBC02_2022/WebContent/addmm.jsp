			...
			<section class="banner full">
				<article>
					...
					<div class="inner">
						...
						String uid = PortNumber.getUid("mm");
						%>
							<h2 style="font-size: 5rem;">Add Manufacturing Manager</h2>
							<form action="AddMM" method="post">
							<table>
							...
							<tr><td><input type="submit" value="Add MM"></td></tr>
							</table>
							</form>
						</header>
					</div>
